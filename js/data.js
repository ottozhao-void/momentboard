window.LEADERBOARD_DATA = {
 ...
 "methods": {
  ...
  "tr-detr": {
   "title": "Query-Dependent DETR for Temporal Sentence Grounding (TR-DETR)",
   "venue": "AAAI",
   "year": 2024,
   "tags": [
    "vmr",
  ...
  "luo-zt": {
   "title": "Training-Free Video Temporal Grounding with Frozen VLM (Luo et al.)",
   "venue": "arXiv",
   "year": 2023,
   "tags": [
    "vmr",
  ...
  "time-r1": {
   "title": "Time-R1: A Reinforcement Learning Approach for Video Temporal Grounding",
   "venue": "arXiv",
   "year": 2025,
   "tags": [
    "vmr",
  ...
  "numpro": {
   "title": "NumPro: Fine-Grained Temporal Grounding with Numeric Prompts",
   "venue": "CVPR",
   "year": 2025,
   "tags": [
    "vmr",
  ...
  "trace": {
   "title": "TRACE: Temporal Reasoning for Accurate Video Grounding with LLMs",
   "venue": "arXiv",
   "year": 2025,
   "tags": [
    "vmr",
  ...
  "mr-blip": {
   "title": "Mr. BLIP: One Reality to Be Edited at a Time",
   "venue": "arXiv",
   "year": 2024,
   "tags": [
    "vmr",
  ...
  "emb": {
   "title": "Beyond Model Adaptation at Test Time: A Survey (EMB baseline)",
   "venue": "arXiv",
   "year": 2023,
   "tags": [
    "vmr",
  ...
  "videochat2": {
   "title": "VideoChat2: Boosting Video-Language Pretraining for Temporal Understanding",
   "venue": "arXiv",
   "year": 2023,
   "tags": [
    "vision-llm"
  ...
  },
  {
   ...
   "rows": [
    ...
    },
    {
     ...
     "setting": "zero-shot",
     "name": "UniVTG*",
     "note": "zero-shot, no NLQ pretraining"
    },
    {
     "method": "videomind",
     "values": {
